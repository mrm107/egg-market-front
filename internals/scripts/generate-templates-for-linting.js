...
componentGen.runActions({
  name: 'RbGeneratedComponentEsclass', type: 'React.Component', wantMessages: true, wantLoadable: true,
})
  .then(checkForErrors)
...
componentGen.runActions({
  name: 'RbGeneratedComponentEsclasspure', type: 'React.PureComponent', wantMessages: true, wantLoadable: true,
})
  .then(checkForErrors)
...
componentGen.runActions({
  name: 'RbGeneratedComponentStatelessfunction', type: 'Stateless Function', wantMessages: true, wantLoadable: true,
})
  .then(checkForErrors)
